...
namespace franka_example_controllers {
    ...
    private:
        ...
        Eigen::Vector3d position_d_target_optitrack;
        Eigen::Quaterniond orientation_d_target_;
        Eigen::Quaterniond orientation_quaternion_;
        Eigen::Matrix3d rotation_matrix;
        
        geometry_msgs::Wrench ext_wrench;
	...
	ros::Publisher franka_q_pose_pub;
        ...
        ros::Publisher post_integration;
        ros::Publisher orientation_target_pub;
        ros::Publisher actual_orientation_pub;
	...
	double stiffness_importata;
        ...
        */
        ...
        ros::Subscriber extwrench_update;
        void ext_wrench_updateCallback(const geometry_msgs::Wrench::ConstPtr& msg3);
